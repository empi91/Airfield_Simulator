...
4. At the same time, try not to include too many high-level and/or complicated aspects – it's still a learning process, following some external guidelines. Is not the time or place to create a fully functional, highly complicated application.
...
12. Limit creating new files to a minimum.

# This project
1. This project is a plane managing simulator: planes arrive in the area of the airport, has limited fuel, and has t be securely led to landing, avoiding other planes, before fuel ends.
2. Tech stack is included below, in  # STACK section.
3. List of task I'm currently working on is in the # TODO section below. 
For now, please do not suggest anything not from that list. However, if there are any design principles that could be followed since the beginning to simplify future integration and development, please mention them in your answer. Keep it simple and don't add too much — it's a learning project.


# TODO
- Implement basic mechanic of server and client (plane)
- Add basic structure of connectiong with database
...
Airport visualisation: In web, using FastAPI
Tests: Unittest